				...
				<div class="row">
					<div class="col-lg-12">
						<div class="section__title text-center">
							...
							<p>Voici les derniers produits ajoutés dans notre base de données. Les nouveaux produits ajoutés récemment.</p>
						<br><br>
						</div>
					</div>
				</div>
			...
			<div class="container">
				...
				<div class="row mt--50">
					<div class="col-md-12 col-lg-12 col-sm-12">
					   ...
					   <a class="nav-item nav-link" data-toggle="tab" href="#nav-biographic" role="tab">{{$cathegorie->c_libelle}}</a>
                        @endforeach
...
-->
				...
				<div class="container">
							<div class="row">
									<div class="col-lg-12">
										<div class="text-center">
											<button type="button" class="btn btn-warning">Voir plus de cathegories</button>
										</div>
									</div>
							</div>
