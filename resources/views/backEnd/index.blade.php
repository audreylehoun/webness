...
@endsection
@section('jsblock')
    <script src="{{asset('ad/js/excanvas.min.js')}}"></script>
    ...
    <script src="{{asset('ad/js/jquery.flot.min.js')}}"></script>
    <script src="{{asset('ad/js/jquery.flot.resize.min.js')}}"></script>
    <script src="{{asset('ad/js/jquery.peity.min.js')}}"></script>
    <script src="{{asset('ad/js/fullcalendar.min.js')}}"></script>
    <script src="{{asset('ad/js/matrix.js')}}"></script>
    <script src="{{asset('ad/js/matrix.dashboard.js')}}"></script>
    <script src="{{asset('ad/js/jquery.gritter.min.js')}}"></script>
    <script src="{{asset('ad/js/matrix.interface.js')}}"></script>
    <script src="{{asset('ad/js/matrix.chat.js')}}"></script>
    <script src="{{asset('ad/js/jquery.validate.js')}}"></script>
    <script src="{{asset('ad/js/jquery.wizard.js')}}"></script>
